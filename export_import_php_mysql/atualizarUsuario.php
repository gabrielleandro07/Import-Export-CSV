...
<html lang="pt-br">
    <head>
        ...
        <?php
            ...
            $query = 'SELECT * FROM tb_usuario WHERE id_usuario =' . $_GET['id'];
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
							...
							<select name="fl_ativo" class="form-control" >
								<option value="1" <?php if($row['fl_ativo'] == 1){echo ' selected ';} ?>>Ativo</option>
								<option value="0" <?php if($row['fl_ativo'] <> 1){echo ' selected ';} ?>>Inativo</option>
							</select>
                        </div>
							...
							<select name="id_perfil" class="form-control" >
								...
								while($row_perfil = mysqli_fetch_assoc($result_perfil)){
									echo '<option value="'.$row_perfil['id_perfil'].'"';
										if($row['id_perfil'] == $row_perfil['id_perfil']) echo ' selected ';
